...
abstract class Contactum_Integration {
    ...
    public function load_settings( $priority = 10 ) {
        ...
        add_action( 'contactum_settings_tabs', [ $this, 'settings_tabs' ], $priority );
        add_action( 'contactum_settings_tab_content_' . $this->id, [ $this, 'settings_panel' ], $priority );
    }
